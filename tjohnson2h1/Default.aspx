<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="tjohnson2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox3CResult" runat="server" Enabled="False" Width="30"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox6C" runat="server" Width="30">1</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox10Result" runat="server" Enabled="False" Width="140px"></asp:TextBox>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox18" runat="server" Width="175px">1250 Homer Rd, Winona</asp:TextBox>
